...
export const IconSnapchat = (p: P) => (
  <svg {...base(p)}>
    <path d="M12 4c-2.3 0-3.9 1.8-3.9 4.1 0 1 .1 1.9-.2 2.5-.3.5-1.1.8-1.9 1 .1.7.9 1.1 1.5 1.3-.1.4-.3.8-.6 1.1.6.3 1.3.3 1.8.5.3.7.9 1.5 3.3 1.5s3-.8 3.3-1.5c.5-.2 1.2-.2 1.8-.5-.3-.3-.5-.7-.6-1.1.6-.2 1.4-.6 1.5-1.3-.8-.2-1.6-.5-1.9-1-.3-.6-.2-1.5-.2-2.5C15.9 5.8 14.3 4 12 4Z" />
  </svg>
);
